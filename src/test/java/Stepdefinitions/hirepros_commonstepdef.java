...
public class hirepros_commonstepdef {
	...
	public void user_has_to_navigate_to_Hirepros_login_page() throws InterruptedException, IOException {
		...
		System.setProperty("webdriver.chrome.driver", Profile.driverPath);
		
		driver = new ChromeDriver();

		driver.get(Configurations.Profile.url);
	...
	public void user_enter_username_and_password_for_Hirepros() throws IOException {
		...
		driver.findElement(By.name(ObjectLocators.userName)).sendKeys(Profile.username);
		driver.findElement(By.name(ObjectLocators.password)).sendKeys(Profile.password);
	...
	public void user_enters_data_to_role_name_field_and_verifies() throws InterruptedException, IOException {
		...
		Thread.sleep(2000);
		String rname = customkeyword.getExcelData(Profile.excelTestData, "ConfigRole", "1", "0");
	...
	public void user_verify_the_added_role_by_searching() throws InterruptedException, IOException {
		...
		driver.findElement(By.xpath(ObjectLocators.searchtxt))
				.sendKeys(customkeyword.getExcelData(Profile.excelTestData, "ConfigRole", "1", "0"));
		Thread.sleep(2000);
	...
	public void user_enters_data_to_customer_name_location_region_field_and_verifies()
		...
		Thread.sleep(3000);
		String cname = customkeyword.getExcelData(Profile.excelTestData, "ConfigRole", "1", "1");
		driver.findElement(By.xpath(ObjectLocators.customerName)).sendKeys(cname); // enter customer field
		Thread.sleep(1000);
		String location = customkeyword.getExcelData(Profile.excelTestData, "ConfigRole", "1", "2");
		driver.findElement(By.xpath(ObjectLocators.location)).sendKeys(location);
		Thread.sleep(1000);
		String region = customkeyword.getExcelData(Profile.excelTestData, "ConfigRole", "1", "3");
	...
	public void user_can_search_customer_name_in_search_text_box() throws InterruptedException, IOException {
		...
		driver.findElement(By.xpath(ObjectLocators.searchtxt)).click();
		driver.findElement(By.xpath(ObjectLocators.searchtxt))
				.sendKeys(customkeyword.getExcelData(Profile.excelTestData, "ConfigRole", "1", "1")); 
		driver.findElement(By.xpath(ObjectLocators.searchbtn)).click(); // clicking search button
		driver.findElement(By.xpath(ObjectLocators.searchResetbtn)).click(); // clicking reset button
	...
	Thread.sleep(2000);
	String bu = customkeyword.getExcelData(Profile.excelTestData, "ConfigRole", "1", "4");
	...
	public void user_can_search_business_unit_name_in_search() throws InterruptedException, IOException {
		...
		Thread.sleep(1000);
		driver.findElement(By.xpath(ObjectLocators.searchtxt))
				.sendKeys(customkeyword.getExcelData(Profile.excelTestData, "ConfigRole", "1", "4"));
		Thread.sleep(1000);
	...
	public void user_enters_data_to_project_name_field_and_verifies() throws InterruptedException, IOException {
		...
		Thread.sleep(2000);
		String pname = customkeyword.getExcelData(Profile.excelTestData, "ConfigRole", "1", "5");
	...
	public void user_has_to_select_Customer_Name_and_Business_Unit_from_the_dropdown_for_Project_creation()
		...
		Thread.sleep(2000);
		String bu = customkeyword.getExcelData(Profile.excelTestData, "ConfigRole", "1", "6");
		Select businessUnit = new Select(driver.findElement(By.xpath(ObjectLocators.projectbu)));
		businessUnit.selectByVisibleText(bu);
		Thread.sleep(2000);
		String cust = customkeyword.getExcelData(Profile.excelTestData, "ConfigRole", "1", "7");
	...
	public void user_can_search_project_name_in_search_text_box() throws InterruptedException, IOException {
		...
		driver.findElement(By.xpath(ObjectLocators.searchtxt)).click();
		driver.findElement(By.xpath(ObjectLocators.searchtxt))
				.sendKeys(customkeyword.getExcelData(Profile.excelTestData, "ConfigRole", "1", "5"));
	...
	public void user_enters_data_to_recruitment_role_name_field_and_verifies()
		...
		Thread.sleep(2000);
		String rr = customkeyword.getExcelData(Profile.excelTestData, "ConfigRole", "1", "8");
	...
	public void user_can_search_recruitment_name_in_search_text_box() throws InterruptedException, IOException {
		...
		driver.findElement(By.xpath(ObjectLocators.searchtxt)).click();
		driver.findElement(By.xpath(ObjectLocators.searchtxt))
				.sendKeys(customkeyword.getExcelData(Profile.excelTestData, "ConfigRole", "1", "8")); 
		driver.findElement(By.xpath(ObjectLocators.searchbtn)).click(); // clicking search button
		driver.findElement(By.xpath(ObjectLocators.searchResetbtn)).click(); // clicking reset button
...
//////////////////////////////////////Custmer RR//////////////////////////////////////////////////////////
	...
	public void user_has_to_select_Business_Unit_Name_and_Purpose_from_the_dropdown_for_Email_Configurations()
		...
		Thread.sleep(2000);
		String business = customkeyword.getExcelData(Profile.excelTestData, "ConfigRole", "1", "15");
		...
		Thread.sleep(1000);
		String purpose = customkeyword.getExcelData(Profile.excelTestData, "ConfigRole", "1", "9");
	...
	public void user_Enters_data_to_To_Cc_and_Bcc_mail_id_and_verifies() throws Throwable {
		...
		driver.findElement(By.xpath(ObjectLocators.to))
				.sendKeys(customkeyword.getExcelData(Profile.excelTestData, "ConfigRole", "1", "10"));
		driver.findElement(By.xpath(ObjectLocators.cc))
				.sendKeys(customkeyword.getExcelData(Profile.excelTestData, "ConfigRole", "1", "11"));
		driver.findElement(By.xpath(ObjectLocators.bcc))
				.sendKeys(customkeyword.getExcelData(Profile.excelTestData, "ConfigRole", "1", "12"));
	...
	public void user_can_select_Role_Name_in_search_text_box() throws Throwable {
		...
		role.selectByVisibleText(customkeyword.getExcelData(Profile.excelTestData, "ConfigRole", "1", "0"));
	...
	public void user_enters_data_to_menu_name_field_and_verifies() throws InterruptedException, IOException {
		...
		Thread.sleep(3000);
		String mainmenu = customkeyword.getExcelData(Profile.excelTestData, "ConfigRole", "1", "13");
	...
	public void user_enters_data_to_sub_menu_name_field_and_verifies() throws InterruptedException, IOException {
		...
		Thread.sleep(3000);
		String mmenu = customkeyword.getExcelData(Profile.excelTestData, "ConfigRole", "1", "13");
		Select mainmenu = new Select(driver.findElement(By.xpath(ObjectLocators.mainmenuselect)));
		mainmenu.selectByVisibleText(mmenu);
		Thread.sleep(3000);
		String submenu = customkeyword.getExcelData(Profile.excelTestData, "ConfigRole", "1", "14");
	...
	public void user_can_search_sub_menu_name_in_search() throws InterruptedException, IOException {
		...
		driver.findElement(By.xpath("//*[@name='keyword']"))
				.sendKeys(customkeyword.getExcelData(Profile.excelTestData, "ConfigRole", "1", "13"));
		Thread.sleep(3000);
	...
	public void user_Enters_data_to_Email_Firstname_Lastname_Designation_Skill_Set_Location_field_and_verifies()
		...
		Thread.sleep(2000);
		String usname = customkeyword.getExcelData(Profile.excelTestData, "User", "1", "0");
		driver.findElement(By.xpath(ObjectLocators.username)).sendKeys(usname); // username
		Thread.sleep(1000);
		String name = customkeyword.getExcelData(Profile.excelTestData, "User", "1", "1");
		driver.findElement(By.xpath(ObjectLocators.firstname)).sendKeys(name); // fname
		Thread.sleep(1000);
		String lname = customkeyword.getExcelData(Profile.excelTestData, "User", "1", "2");
		driver.findElement(By.xpath(ObjectLocators.lastname)).sendKeys(lname); // Lname
		Thread.sleep(1000);
		String number = customkeyword.getExcelData(Profile.excelTestData, "User", "1", "3");
		driver.findElement(By.xpath(ObjectLocators.contactnum)).sendKeys(number); // number
		Thread.sleep(1000);
		String designation = customkeyword.getExcelData(Profile.excelTestData, "User", "1", "4");
		driver.findElement(By.xpath(ObjectLocators.designation)).sendKeys(designation); // Designation
		Thread.sleep(1000);
		String skillSet = customkeyword.getExcelData(Profile.excelTestData, "User", "1", "5");
		driver.findElement(By.xpath(ObjectLocators.skillset1)).sendKeys(skillSet); // skillSet
		Thread.sleep(1000);
		String location = customkeyword.getExcelData(Profile.excelTestData, "User", "1", "6");
	...
	public void User_has_to_select_Business_Unit_Gender_and_Role_Name_from_the_dropdown_for_Users_creation()
		...
		Thread.sleep(1000);
		String rl = customkeyword.getExcelData(Profile.excelTestData, "User", "1", "7");
		Select Role = new Select(driver.findElement(By.xpath(ObjectLocators.role1)));
		Role.selectByVisibleText(rl);
		Thread.sleep(1000);
		String bu = customkeyword.getExcelData(Profile.excelTestData, "User", "1", "8");
	...
	public void User_Enters_data_to_EmployeeId_By_HR_WorkOrderNumber_Employment_Type_FirstName_LastName_ContactNo_Email_Gender_Project_Allocation_Project_Name_CustomerName_Business_Unit_Designation_Skillset_field_and_verifies()
		...
		String Empidbyhr = customkeyword.getExcelData(Profile.excelTestData, "Resource", s, "0");
		...
		driver.findElement(By.xpath(ObjectLocators.workordernumber))
				.sendKeys(customkeyword.getExcelData(Profile.excelTestData, "Resource", s, "1"));
		Thread.sleep(1000);
		Select emptype = new Select(driver.findElement(By.xpath(ObjectLocators.employmenttype)));
		emptype.selectByVisibleText(customkeyword.getExcelData(Profile.excelTestData, "Resource", s, "2"));
		Thread.sleep(1000);
		driver.findElement(By.xpath(ObjectLocators.firstName))
				.sendKeys(customkeyword.getExcelData(Profile.excelTestData, "Resource", s, "3"));
		Thread.sleep(1000);
		driver.findElement(By.xpath(ObjectLocators.lastName))
				.sendKeys(customkeyword.getExcelData(Profile.excelTestData, "Resource", s, "4"));
		Thread.sleep(1000);
		driver.findElement(By.xpath(ObjectLocators.contactNo))
				.sendKeys(customkeyword.getExcelData(Profile.excelTestData, "Resource", s, "5"));
		Thread.sleep(1000);
		driver.findElement(By.xpath(ObjectLocators.remail))
				.sendKeys(customkeyword.getExcelData(Profile.excelTestData, "Resource", s, "6"));
		Thread.sleep(1000);
		...
		driver.findElement(By.xpath(ObjectLocators.projectallocation))
				.sendKeys(customkeyword.getExcelData(Profile.excelTestData, "Resource", s, "7"));
		Select bu = new Select(driver.findElement(By.xpath(ObjectLocators.rebu)));
		bu.selectByVisibleText(customkeyword.getExcelData(Profile.excelTestData, "Resource", s, "8"));
		Thread.sleep(3000);
		driver.findElement(By.xpath(ObjectLocators.rdesignation))
				.sendKeys(customkeyword.getExcelData(Profile.excelTestData, "Resource", s, "9"));
		Thread.sleep(1000);
		driver.findElement(By.xpath(ObjectLocators.rexp))
				.sendKeys(customkeyword.getExcelData(Profile.excelTestData, "Resource", s, "10"));
		Thread.sleep(1000);
		driver.findElement(By.xpath(ObjectLocators.rskillset))
				.sendKeys(customkeyword.getExcelData(Profile.excelTestData, "Resource", s, "11"));
	}
	...
	public void user_enters_data_to_vendor_name_contact_no_email_location_address_and_cc_email_ids_field_and_verifies()
			throws InterruptedException {
		Thread.sleep(2000);
		driver.findElement(By.xpath(ObjectLocators.vendorName)).sendKeys("111");
		Thread.sleep(1000);
		driver.findElement(By.xpath(ObjectLocators.vendorEmail)).sendKeys("fgh@gm.com");
		Thread.sleep(1000);
		driver.findElement(By.xpath(ObjectLocators.vendorContactNo)).sendKeys("09876556789876");
		Thread.sleep(1000);
		...
		Thread.sleep(1000);
		driver.findElement(By.xpath(ObjectLocators.vendorCCEmail)).sendKeys("fgh@gm.com");
	...
	public void user_has_to_fill_the_details_of_Customer_Name_Recruitment_Role_Business_Unit_Currency_Type_Pay_Frequency_Employment_Type_Project_Start_Date_Placement_For_Remote_Working_Recruiter_No_of_Openings_Email_Firstname_Lastname_Location_Pay_Range_Contract_Duration_Job_Description_Mandatory_Skills_Optional_Skills_and_save_the_job_request()
		...
		String value = customkeyword.getRowCount(Profile.excelTestData, "Jobrequest");
		...
		for (row = 1; row <= rows; row++) {
			...
			Thread.sleep(3000);
			String cust = customkeyword.getExcelData(Profile.excelTestData, "Jobrequest", s, "0");
			Select customer = new Select(driver.findElement(By.xpath(ObjectLocators.customerfield)));
			customer.selectByVisibleText(cust);
			Thread.sleep(3000);
			String recruitment = customkeyword.getExcelData(Profile.excelTestData, "Jobrequest", s, "1");
			...
			Thread.sleep(3000);
			String business = customkeyword.getExcelData(Profile.excelTestData, "Jobrequest", s, "2");
			Select businessUnit = new Select(driver.findElement(By.xpath(ObjectLocators.bunit)));
			businessUnit.selectByVisibleText(business);
			Thread.sleep(1000);
			String currency = customkeyword.getExcelData(Profile.excelTestData, "Jobrequest", s, "5");
			...
			Thread.sleep(1000);
			String payf = customkeyword.getExcelData(Profile.excelTestData, "Jobrequest", s, "7");
			Select payFrequency = new Select(driver.findElement(By.xpath(ObjectLocators.payrange)));
			payFrequency.selectByVisibleText(payf);
			Thread.sleep(1000);
			String empt = customkeyword.getExcelData(Profile.excelTestData, "Jobrequest", s, "8");
			...
			Thread.sleep(4000);
			robot.mouseMove(coordinates.getX() + 240, coordinates.getY() + 155);
			Thread.sleep(3000);
			...
			String pf = customkeyword.getExcelData(Profile.excelTestData, "Jobrequest", s, "11");
			...
			Thread.sleep(1000);
			String rw = customkeyword.getExcelData(Profile.excelTestData, "Jobrequest", s, "12");
			...
			Thread.sleep(1000);
			String recruit = customkeyword.getExcelData(Profile.excelTestData, "Jobrequest", s, "13");
			Select recruiter = new Select(driver.findElement(By.xpath(ObjectLocators.recruiter)));
			recruiter.selectByVisibleText(recruit);
			Thread.sleep(1000);

			String nop = customkeyword.getExcelData(Profile.excelTestData, "Jobrequest", s, "3");
			...
			driver.findElement(By.xpath(ObjectLocators.location1))
					.sendKeys(customkeyword.getExcelData(Profile.excelTestData, "Jobrequest", s, "4"));
			Thread.sleep(1000);
			String Payrange = customkeyword.getExcelData(Profile.excelTestData, "Jobrequest", s, "6");
			...
			driver.findElement(By.xpath(ObjectLocators.contractduration))
					.sendKeys(customkeyword.getExcelData(Profile.excelTestData, "Jobrequest", s, "9"));
			Thread.sleep(1000);
			driver.findElement(By.xpath(ObjectLocators.jobdescription)).clear();
			driver.findElement(By.xpath(ObjectLocators.jobdescription))
					.sendKeys(customkeyword.getExcelData(Profile.excelTestData, "Jobrequest", s, "14"));
			Thread.sleep(1000);
			...
			driver.findElement(By.xpath(ObjectLocators.mandatoryskills))
					.sendKeys(customkeyword.getExcelData(Profile.excelTestData, "Jobrequest", s, "15"));
			Thread.sleep(1000);
			driver.findElement(By.xpath(ObjectLocators.optionalskills)).clear();
			driver.findElement(By.xpath(ObjectLocators.optionalskills))
					.sendKeys(customkeyword.getExcelData(Profile.excelTestData, "Jobrequest", s, "16"));
	...
	public void user_can_fill_the_details_to_Firstname_Lastname_Contact_Number_Email_Years_of_Experience_Current_Company_Name_Skill_Set_CandidateType_Gender_Resume_Upload_and_verifies()
		...
		String value = customkeyword.getRowCount(Profile.excelTestData, "Candidate");

		int rows = Integer.parseInt(value);
		for (row = 1; row <= rows; row++) {
			String s = Integer.toString(row);
			System.out.println(customkeyword.getExcelData(Profile.excelTestData, "Candidate", s, "0"));
			Thread.sleep(3000);

			driver.findElement(By.xpath(ObjectLocators.fname))
					.sendKeys(customkeyword.getExcelData(Profile.excelTestData, "Candidate", s, "0"));

			Thread.sleep(1000);
			String lastName = customkeyword.getExcelData(Profile.excelTestData, "Candidate", s, "1");
			driver.findElement(By.xpath(ObjectLocators.lname)).sendKeys(lastName);
			Thread.sleep(1000);
			String contactno = customkeyword.getExcelData(Profile.excelTestData, "Candidate", s, "2");
			...
			Thread.sleep(1000);
			String email = customkeyword.getExcelData(Profile.excelTestData, "Candidate", s, "3");
			driver.findElement(By.xpath(ObjectLocators.email)).sendKeys(email);
			Thread.sleep(1000);

			String exp = customkeyword.getExcelData(Profile.excelTestData, "Candidate", s, "4");
			...
			String currentCompanyName = customkeyword.getExcelData(Profile.excelTestData, "Candidate", s, "5");
			driver.findElement(By.xpath(ObjectLocators.currentcom)).sendKeys(currentCompanyName);
			String skillset = customkeyword.getExcelData(Profile.excelTestData, "Candidate", s, "7");
			...
			radio.click();
			String candidateType = customkeyword.getExcelData(Profile.excelTestData, "Candidate", s, "6");
			...
			Thread.sleep(1000);
			driver.findElement(By.xpath(ObjectLocators.resumeupload)).sendKeys(Profile.resumeUpload);
			Thread.sleep(1000);
			JavascriptExecutor js = (JavascriptExecutor) driver;
			js.executeScript("window.scrollBy(0,1000)");
	...
	public void User_has_to_select_Bench_candidate_from_the_list_and_upload_resume_and_save_the_candidate()
		...
		Thread.sleep(5000);
		File file = new File(new File(Profile.resumeUpload).getAbsolutePath());
	...
	public void user_can_fill_the_details_of_Interviewer_mode_of_interview_date_time_duration_timezone_venue_remarks_and_verifies()
		...
		for (row = 1; row <= 1; row++) {
			...
			System.out.println(customkeyword.getExcelData(Profile.excelTestData, "Internalround1", s, "0"));

			Thread.sleep(3000);

			String Interview = customkeyword.getExcelData(Profile.excelTestData, "Internalround1", s, "0");
			...
			Thread.sleep(1000);
			String modeofinterview = customkeyword.getExcelData(Profile.excelTestData, "Internalround1", s, "1");
			...
			Thread.sleep(1000);
			String time = customkeyword.getExcelData(Profile.excelTestData, "Internalround1", s, "3");
			driver.findElement(By.xpath(ObjectLocators.startsfrom)).sendKeys(time);
			Thread.sleep(1000);

			String Duration = customkeyword.getExcelData(Profile.excelTestData, "Internalround1", s, "4");

			Select duration = new Select(driver.findElement(By.xpath(ObjectLocators.duration)));
			duration.selectByVisibleText(Duration);
			Thread.sleep(1000);

			String Timezone = customkeyword.getExcelData(Profile.excelTestData, "Internalround1", s, "5");
			...
			Thread.sleep(1000);
			String venue = customkeyword.getExcelData(Profile.excelTestData, "Internalround1", s, "6");
			driver.findElement(By.xpath(ObjectLocators.venue)).sendKeys(venue);
			Thread.sleep(1000);
			String remarks = customkeyword.getExcelData(Profile.excelTestData, "Internalround1", s, "7");
			...
			Thread.sleep(2000);
			String approvestatus = customkeyword.getExcelData(Profile.excelTestData, "BUApproval", s, "0");
			Select status = new Select(driver.findElement(By.xpath(ObjectLocators.status)));
			status.selectByVisibleText(approvestatus);
			Thread.sleep(2000);
			String approval = customkeyword.getExcelData(Profile.excelTestData, "BUApproval", s, "1");
	...
	public void user_can_fill_the_details_of_Interviewer_mode_of_interview_date_time_duration_timezone_venue_remarks_and_verifies_from_the_Customer_Round()
		...
		for (row = 1; row <= 1; row++) {
			...
			System.out.println(customkeyword.getExcelData(Profile.excelTestData, "CustomerRound", s, "0"));

			Thread.sleep(3000);

			String Interview = customkeyword.getExcelData(Profile.excelTestData, "CustomerRound", s, "0");
			...
			Thread.sleep(1000);
			String modeofinterview = customkeyword.getExcelData(Profile.excelTestData, "CustomerRound", s, "1");
			Select ModeofInterview = new Select(driver.findElement(By.xpath(ObjectLocators.modeofinterview)));
			ModeofInterview.selectByVisibleText(modeofinterview);
			Point coordinates = driver.findElement(By.xpath("(//*[@name='scheduleDateTime'])[1]")).getLocation();
			Thread.sleep(1000);
			...
			Thread.sleep(1000);
			String time = customkeyword.getExcelData(Profile.excelTestData, "CustomerRound", s, "3");
			driver.findElement(By.xpath(ObjectLocators.startsfrom)).sendKeys(time);

			Thread.sleep(1000);

			String Duration = customkeyword.getExcelData(Profile.excelTestData, "CustomerRound", s, "4");
			...
			String venue = customkeyword.getExcelData(Profile.excelTestData, "CustomerRound", s, "6");
			driver.findElement(By.xpath(ObjectLocators.venue)).sendKeys(venue);
			Thread.sleep(1000);
			String remarks = customkeyword.getExcelData(Profile.excelTestData, "CustomerRound", s, "7");
			driver.findElement(By.xpath(ObjectLocators.remarks)).sendKeys(remarks);
...
/////////////////////////////////// BU HeadApproval//////////////////////////////////////////
	...
	public void user_click_on_approve_hold_and_reject_by_adding_comment() throws InterruptedException, IOException {
		...
		Thread.sleep(3000);
		String approval = customkeyword.getExcelData(Profile.excelTestData, "BUApproval", "1", "1");
...
//				customkeyword.getExcelData(Profile.excelTestData, "Onboarddetails", s, "3"));
		...
		project.selectByVisibleText(customkeyword.getExcelData(Profile.excelTestData, "Onboarddetails", s, "5"));
